...
full_template_file = r'.\Templates\ROCKPROPS-borehole-samples-downhole intervals-2021.06-for_input.XLSX'
template_file = r'.\Templates\ROCKPROPS-jav_cols.XLSX'
metadata_file = r'.\Config\Javelin_bores_for_loading.xlsx'
